...
struct ResponsesRequestFactory {
    ...
    func makeCreateRequest(items: [RequestItem], previousResponseId: String?, stream: Bool) throws -> URLRequest {
    ...
    func makeRetrieveRequest(responseId: String) -> URLRequest {
