...
public struct ResponsesClient {
    ...
    public func retrieveResponse(id: String) async throws -> APIResponse {
    ...
    private func send(_ request: URLRequest) async throws -> APIResponse {
        ...
        guard let http = response as? HTTPURLResponse else {
            throw OpenAIClientError.invalidResponse(statusCode: -1)
        }
    ...
    private func sendStream(
        ...
        throw OpenAIClientError.apiError("Streaming response missing terminal event.")
    }
